		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "First App- Cross",
									"targetURL": "#comsaplearningfirstapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplearningfirstapp-display": {
								"semanticObject": "comsaplearningfirstapp",
								"action": "display",
								"description": "First App- Cross",
								"title": "First App- Cross",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.learning.firstapp",
									"url": sap.ui.require.toUrl("com/sap/learning/firstapp")
								}
							}
						}
					}
